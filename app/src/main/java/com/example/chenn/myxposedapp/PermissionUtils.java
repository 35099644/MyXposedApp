...
public class PermissionUtils {
    ...
    public static void requestPermissions(final Activity activity, String[] reqs, PermissionGrant permissionGrant){

        if (activity == null) {
            return;
        }

        requestPermissions = reqs;

        requestMultiPermissions(activity, permissionGrant);
    }
